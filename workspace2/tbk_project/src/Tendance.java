...
// Recupere les tendances actuelles de Twitter. Les exceptions rejetees eventuelles 
// sont prises en compte dans la classe

public class Tendance {

    // Methode renvoyant un vector de string. Ces sring sont les tendances de Twitter
	public static Vector<String> getTrend() {
